...
describe("generateKeywords", () => {
    ...
    describe("heading extraction", () => {
        test("extracts words from markdown headings", () => {
            const keywords = generateKeywords("readme.md", "# Getting Started\n\n## Installation Guide\n\nSome text.");
        ...
        test("extracts words from deep headings", () => {
            const keywords = generateKeywords("doc.md", "### API Reference\n\n#### Authentication Endpoints\n\nContent.");
            expect(keywords).toContain("api");
    ...
    describe("stop words", () => {
        test("filters out common stop words", () => {
            const keywords = generateKeywords("the-guide-and-setup.md", "# The Quick Guide\n\n## Setup Instructions\n\nFor a good example.");
        ...
        test('"their" appears only once in stop-word set', () => {
            ...
            const keywords = generateKeywords("their-document.md", "# Their Document\n\nContent about their approach.");
        ...
        test("pronouns are filtered", () => {
            const keywords = generateKeywords("readme.md", "# I you he she it we they\n\nContent about me him her us them.");
        ...
        test("prepositions are filtered", () => {
            const keywords = generateKeywords("readme.md", "# in on at by for with about to from of\n\nContent.");
            expect(keywords).not.toContain("for");
    ...
    describe("deduplication", () => {
        test("deduplicates keywords from multiple sources", () => {
            ...
            const keywords = generateKeywords("api-guide.md", "# API Guide\n\nfunction apiHelper() {}");
    ...
    describe("20-keyword cap", () => {
        test("never returns more than 20 keywords", () => {
            ...
            const keywords = generateKeywords("doc.md", `# ${manyWords}\n\n${Array.from({ length: 30 }, (_, i) => `function func${i}() {}`).join("\n")}`);
    ...
    describe("edge cases", () => {
        ...
        test("handles content without headings or code symbols", () => {
            const keywords = generateKeywords("overview.md", "Just some plain text content without any structure.");
        ...
        test("all keywords are lowercase", () => {
            const keywords = generateKeywords("API-Guide.md", "# Getting Started\n\nexport class ApiClient {}\n");
...
//# sourceMappingURL=keyword-gen.test.js.map