 ...
 */
export function generateKeywords(fileName, content) {
    const keywords = [];
...
function addFromFilename(fileName, out) {
    // Strip extension(s)
...
function addFromHeadings(content, out) {
...
function addFromCodeSymbols(content, out) {
